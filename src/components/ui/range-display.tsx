    ...
    return (
        <div className="rounded-lg p-4 max-w-lg w-full bg-primary-20 my-1">
            <div className="flex justify-between items-center mb-4">
                ...
                <div className="flex items-center text-sm border border-primary-40 p-1 rounded-sm">
            ...
            <div className="grid grid-cols-2 gap-1.5">
                <button
                    ...
                    className="text-sm font-medium py-2 px-4 rounded-lg transition duration-300 bg-primary-40 hover:brightness-90 text-primary"
                >
                    Recalculate
                </button>
                <button
                    onClick={onConfirmStake}
                    className="text-sm font-medium py-2 px-4 rounded-lg transition duration-300 bg-primary hover:brightness-90 text-black"
                >
                    Confirm Stake
                </button>
            </div>
